...
"""
    ...
    def from_markdown(cls,content:str)->"SkillDefinition":
        ...
        return cls(
            ...
            triggers=section("Triggers"), inputs=section("Inputs"),
            outputs=section("Outputs"), procedure=section("Procedure"),
            quality_checks=section("Quality Checks"), permissions=section("Permissions"),
...
class SkillStore:
    ...
    def save(self,skill:SkillDefinition)->Path:
        p=self.path_for(skill.name)
        p.write_text(skill.to_markdown(),encoding="utf-8")
        return p
    ...
    def list(self)->list[SkillDefinition]:
        return [
            SkillDefinition.from_markdown(p.read_text(encoding="utf-8"))
